...
let entrepreneursCurrentAge = entrepreneurs.map(entrepreneur => {
  return {name : entrepreneur.first, age: currentYear - entrepreneur.year};
});
console.log(entrepreneursCurrentAge);